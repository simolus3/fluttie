...
class Fluttie {
	...
	Future<int> loadAnimationFromResource(String key, {AssetBundle bundle}) async {
		...
		var contentBytes = await (bundle ?? rootBundle).load(key);
		var contentString = UTF8.decode(new Uint8List.view(contentBytes.buffer));

		return await loadAnimationFromJson(contentString);
	}
